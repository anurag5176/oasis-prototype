...
export default function CommunitiesPage() {
  return (
    <AnimationWrapper>
      ...
      {/* Communities Grid */}
      <section id="communities" className="py-20 bg-section-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl font-bold text-gray-900 mb-6 fade-in-up">Active Communities</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-container">
            {/* Community Cards */}
            <Card className="border-gray-200 hover:shadow-lg transition-shadow overflow-hidden stagger-item card-hover">
              ...
              <CardContent>
                ...
                <Button className="w-full bg-[#1A4E8A] hover:bg-[#1A4E8A]/90 text-white">Join Community</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 hover:shadow-lg transition-shadow overflow-hidden stagger-item card-hover">
              <div className="h-48 relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#1A4E8A] text-white">Growing</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-2 text-gray-600 mb-2">
              ...
              <CardContent>
                ...
                <Button className="w-full bg-[#4DA6A6] hover:bg-[#4DA6A6]/90 text-white">Join Community</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 hover:shadow-lg transition-shadow overflow-hidden">
              <div className="h-48 relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#4DA6A6] text-white">New</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-2 text-gray-600 mb-2">
            ...
            <Card className="border-gray-200 hover:shadow-lg transition-shadow overflow-hidden stagger-item card-hover">
              <div className="h-48 relative">
                <div className="absolute inset-0 bg-[#4DA6A6] flex items-center justify-center">
                  <span className="text-white font-bold text-lg">Virtual Community</span>
                </div>
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#4DA6A6] text-white">Online</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-2 text-gray-600 mb-2">
              ...
              <CardContent>
                ...
                <Button className="w-full bg-[#1A4E8A] hover:bg-[#1A4E8A]/90 text-white">Join Online</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 hover:shadow-lg transition-shadow overflow-hidden stagger-item card-hover">
              <div className="h-48 relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#1A4E8A] text-white">Active</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-2 text-gray-600 mb-2">
            ...
            <Card className="border-gray-200 hover:shadow-lg transition-shadow overflow-hidden stagger-item card-hover">
              <div className="h-48 relative">
                <div className="absolute inset-0 bg-[#4DA6A6] flex items-center justify-center">
                  <span className="text-white font-bold text-lg">Start New</span>
                </div>
              </div>
              <CardHeader>
              ...
              <CardContent>
                ...
                <Button className="w-full bg-[#4DA6A6] hover:bg-[#4DA6A6]/90 text-white">Start a Circle</Button>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger-container">
            <div className="text-center stagger-item">
              <div className="w-16 h-16 bg-[#1A4E8A]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-[#1A4E8A] font-bold text-2xl">1</span>
              </div>
            ...
            <div className="text-center stagger-item">
                              <div className="w-16 h-16 bg-[#1A4E8A]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-[#1A4E8A] font-bold text-2xl">2</span>
              </div>
            ...
            <div className="text-center stagger-item">
                              <div className="w-16 h-16 bg-[#4DA6A6]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-[#4DA6A6] font-bold text-2xl">3</span>
              </div>
