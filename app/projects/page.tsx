...
export default function ProjectsPage() {
  return (
    <AnimationWrapper>
      ...
      {/* Upcoming Events */}
      <section id="upcoming" className="py-20 bg-[#F4E1C1]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl font-bold text-gray-900 mb-6">Upcoming Events</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="border-[#1A4E8A] hover:shadow-lg transition-shadow overflow-hidden bg-white">
              <div className="h-48 relative">
                <Image src="/images/wisdom-circle.png" alt="Storytelling workshop" fill className="object-cover" />
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#1A4E8A] text-white">This Weekend</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-4 text-sm text-[#1A4E8A] mb-2">
                ...
                <CardTitle className="text-[#1A4E8A]">Storytelling Workshop</CardTitle>
                <CardDescription className="text-[#1A4E8A]">
              ...
              <CardContent>
                <div className="flex items-center gap-4 text-sm text-[#1A4E8A] mb-4">
                  <div className="flex items-center gap-1">
                ...
                <Button className="w-full bg-[#1A4E8A] hover:bg-[#1A4E8A]/90 text-white">Register Now</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#1A4E8A] hover:shadow-lg transition-shadow overflow-hidden bg-white">
              <div className="h-48 relative">
                <div className="absolute inset-0 bg-[#4DA6A6] flex items-center justify-center">
                  <span className="text-white font-bold text-xl">Community Garden</span>
                </div>
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#4DA6A6] text-white">Next Week</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-4 text-sm text-[#1A4E8A] mb-2">
                ...
                <CardTitle className="text-[#1A4E8A]">Community Garden Day</CardTitle>
                <CardDescription className="text-[#1A4E8A]">
              ...
              <CardContent>
                ...
                <Button className="w-full bg-[#4DA6A6] hover:bg-[#4DA6A6]/90 text-white">Register Now</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#1A4E8A] hover:shadow-lg transition-shadow overflow-hidden bg-white">
              <div className="h-48 relative">
                <div className="absolute inset-0 bg-[#1A4E8A] flex items-center justify-center">
                  <span className="text-white font-bold text-xl">Tech Skills</span>
                </div>
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#1A4E8A] text-white">Monthly</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-4 text-sm text-[#1A4E8A] mb-2">
                ...
                <CardTitle className="text-[#1A4E8A]">Tech Skills Exchange</CardTitle>
                <CardDescription className="text-[#1A4E8A]">
            ...
            <Card className="border-[#1A4E8A] hover:shadow-lg transition-shadow overflow-hidden bg-white">
              <div className="h-48 relative">
                <div className="absolute inset-0 bg-[#4DA6A6] flex items-center justify-center">
                  <span className="text-white font-bold text-xl">Cultural Night</span>
                </div>
                <div className="absolute top-4 left-4">
                  <Badge className="bg-[#4DA6A6] text-white">Special Event</Badge>
                </div>
              </div>
              <CardHeader>
                <div className="flex items-center gap-4 text-sm text-[#1A4E8A] mb-2">
                ...
                <CardTitle className="text-[#1A4E8A]">Heritage & Culture Night</CardTitle>
                <CardDescription className="text-[#1A4E8A]">
      ...
      <section className="py-20 bg-[#1A4E8A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl font-bold text-white mb-6">Ongoing Projects</h2>
            <p className="text-xl text-white/90">Long-term initiatives creating lasting impact in our communities</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-[#1A4E8A] bg-white">
              <CardHeader>
                <div className="w-12 h-12 bg-[#1A4E8A]/10 rounded-lg flex items-center justify-center mb-4">
                  <Users className="h-6 w-6 text-[#1A4E8A]" />
                </div>
                <CardTitle className="text-[#1A4E8A]">Wisdom Archive Project</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#1A4E8A] mb-4">
                  Recording and preserving life stories from community members to create a digital archive for future
                  generations.
                </CardDescription>
                <div className="text-sm text-[#1A4E8A] mb-4">
                  <strong>Progress:</strong> 127 stories collected
                </div>
                <Button
                  variant="outline"
                  className="w-full border-[#1A4E8A] text-[#1A4E8A] hover:bg-[#1A4E8A]/10 bg-transparent"
                >
                  Learn More
                </Button>
              </CardContent>
            ...
            <Card className="border-[#1A4E8A] bg-white">
              <CardHeader>
                <div className="w-12 h-12 bg-[#4DA6A6]/10 rounded-lg flex items-center justify-center mb-4">
                  <MapPin className="h-6 w-6 text-[#4DA6A6]" />
                </div>
                <CardTitle className="text-[#1A4E8A]">Neighborhood Connections</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#1A4E8A] mb-4">
                ...
                <Button
                  variant="outline"
                  className="w-full border-[#4DA6A6] text-[#4DA6A6] hover:bg-[#4DA6A6]/10 bg-transparent"
                >
                  Volunteer
                </Button>
              </CardContent>
            ...
            <Card className="border-[#1A4E8A] bg-white">
              <CardHeader>
                <div className="w-12 h-12 bg-[#1A4E8A]/10 rounded-lg flex items-center justify-center mb-4">
                  <Calendar className="h-6 w-6 text-[#1A4E8A]" />
                </div>
                <CardTitle className="text-[#1A4E8A]">Skills Mentorship Program</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#1A4E8A] mb-4">
      ...
      {/* Get Involved CTA */}
      <section className="py-20 bg-[#F4E1C1]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-4xl font-bold text-[#1A4E8A] mb-6">Ready to Get Involved?</h2>
          <p className="text-xl text-[#1A4E8A] mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              size="lg"
              variant="secondary"
              className="bg-[#1A4E8A] text-white hover:bg-[#1A4E8A]/90 shadow-xl text-lg px-6 py-4"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-2 border-[#1A4E8A] text-[#1A4E8A] hover:bg-[#1A4E8A] hover:text-white bg-transparent shadow-xl text-lg px-6 py-4"
            >
